...
const TemaFracasaste = new Audio("./sonidos/Game_Over.wav");
const sonidoVictoria = new Audio("./sonidos/Level_Clear.wav");
const TemaPausa = new Audio("./sonidos/Pause.wav");
const TemaPoder = new Audio("./sonidos/Powerup.wav");
...
function derecha() {
  if (derechaPresionado) {
    ...
    const posicionMario = parseInt (mario.style.left) || 75
